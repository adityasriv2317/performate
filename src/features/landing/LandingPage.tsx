      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10 w-full">
          <div className="flex flex-col items-center bg-gray-50 rounded-lg p-5 shadow-sm border border-gray-100">
            ...
            <span className="font-semibold text-gray-800">List & Run Actors</span>
            <span className="text-xs text-gray-500 mt-1">Browse and execute your Apify actors instantly.</span>
          </div>
          <div className="flex flex-col items-center bg-gray-50 rounded-lg p-5 shadow-sm border border-gray-100">
            <BarChart3 className="w-8 h-8 text-blue-500 mb-2" />
            <span className="font-semibold text-gray-800">Visualize Results</span>
            <span className="text-xs text-gray-500 mt-1">See your actor outputs in a clear, modern UI.</span>
          </div>
          <div className="flex flex-col items-center bg-gray-50 rounded-lg p-5 shadow-sm border border-gray-100">
            <ShieldCheck className="w-8 h-8 text-blue-500 mb-2" />
            <span className="font-semibold text-gray-800">Secure & Private</span>
            <span className="text-xs text-gray-500 mt-1">Your API key and data are always protected.</span>
          </div>
        </div>
        <Link href="/auth" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold shadow hover:bg-blue-700 transition">
